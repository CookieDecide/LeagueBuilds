...
def update_runes():
    ...
    current_runes_reforged_list = lol_watcher.data_dragon.runes_reforged(
        runes_reforged_version
    )
...
def update_champions():
    ...
    current_champ_list = lol_watcher.data_dragon.champions(
        version=champions_version, full=True
    )
    ...
    for champion in data:
        champions.append(
            {
                ...
                "stats_spellblockperlevel": data[champion]["stats"][
                    "spellblockperlevel"
                ],
        ...
        global patch
        patch = champions_version.split(".")[0] + "." + champions_version.split(".")[1]
...
def get_patch():
    ...
    return champions_version.split(".")[0] + "." + champions_version.split(".")[1]
